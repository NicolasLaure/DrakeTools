namespace DrakeToolbox.Mathematics
{
    public class MY4X4 : IEquatable<MY4X4>
    {
        ...
        public MY4X4(Vec4 column0, Vec4 column1, Vec4 column2, Vec4 column3)
        {
            m00 = column0.x;
            m10 = column0.y;
            m20 = column0.z;
        ...
        {
            get { return new MY4X4(Vec4.zero, Vec4.zero, Vec4.zero, Vec4.zero); }
        }
        ...
        public static MY4X4 identity
        {
            get
            {
                Vec4 col1 = new Vec4(1, 0);
                Vec4 col2 = new Vec4(0, 1);
                Vec4 col3 = new Vec4(0, 0, 1);
                Vec4 col4 = new Vec4(0, 0, 0, 1);
        ...
        public static Vec4 operator *(MY4X4 lhs, Vec4 vector)
        {
            ...
            return new Vec4(x, y, z, vector.w);
        }

        public static MY4X4 operator *(MY4X4 lhs, MY4X4 rhs)
        {
            MY4X4 newMatrix = zero;
        ...
        public static MY4X4 Inverse(MY4X4 m)
        {
            ...
            row0 = new Vec4(m00determine, m01determine, m02determine, m03determine);
            ...
            row1 = new Vec4(m10determine, m11determine, m12determine, m13determine);
            ...
            row2 = new Vec4(m20determine, m21determine, m22determine, m23determine);
            ...
            row3 = new Vec4(m30determine, m31determine, m32determine, m33determine);
        ...
        public static MY4X4 Rotate(MyQuaternion q)
        {
            ...
            Vec4 firstColumn = new Vec4(2 * (rotation.w * rotation.w + rotation.x * rotation.x) - 1,
            2 * (rotation.x * rotation.y + rotation.w * rotation.z),
            2 * (rotation.x * rotation.z - rotation.w * rotation.y),
            0);

            Vec4 secondColumn = new Vec4(2 * (rotation.x * rotation.y - rotation.w * rotation.z),
            2 * (rotation.w * rotation.w + rotation.y * rotation.y) - 1,
            2 * (rotation.y * rotation.z + rotation.w * rotation.x),
            0);

            Vec4 thirdColumn = new Vec4(2 * (rotation.x * rotation.z + rotation.w * rotation.y),
            2 * (rotation.y * rotation.z - rotation.w * rotation.x),
            2 * (rotation.w * rotation.w + rotation.z * rotation.z) - 1,
            0);

            Vec4 fourthColumn = new Vec4(0, 0, 0, 1);
        ...
        {
            Vec4 col1 = new Vec4(vector.x, 0);
            Vec4 col2 = new Vec4(0, vector.y);
            Vec4 col3 = new Vec4(0, 0, vector.z);
            Vec4 col4 = new Vec4(0, 0, 0, 1);
            return new MY4X4(col1, col2, col3, col4);
        }
        ...
        public static MY4X4 Translate(Vec3 vector)
        {
            ...
            Vec4 col2 = new Vec4(0, 1);
            Vec4 col3 = new Vec4(0, 0, 1);
            Vec4 col4 = new Vec4(vector.x, vector.y, vector.z, 1);
            return new MY4X4(col1, col2, col3, col4);
        }

        public static MY4X4 Transpose(MY4X4 m)
        {
            Vec4 row0 = m.GetRow(0);
            Vec4 row1 = m.GetRow(1);
            Vec4 row2 = m.GetRow(2);
            Vec4 row3 = m.GetRow(3);
        ...
        {
            Vec4 v4Point = new Vec4(point.x, point.y, point.z, 1);
