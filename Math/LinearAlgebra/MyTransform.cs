...
namespace DrakeToolbox.Mathematics
{
    ...
    public class MyTransform : IEnumerable
    {
        ...
        private Vec3 rotationEulers;
        private MyQuaternion localRotation;
        private Vec3 scale;
        ...
        public void Translate(Vec3 translation, MyTransform relativeTo)
        {
            ...
            auxRelativeWorldMatrix.SetColumn(3, new Vec4(0, 0, 0, 1));

            Vec4 result = auxRelativeWorldMatrix * new Vec4(translation.x, translation.y, translation.z, 1);
