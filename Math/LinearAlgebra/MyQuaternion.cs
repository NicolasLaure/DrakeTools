namespace DrakeToolbox.Mathematics
{
    ...
    public class MyQuaternion : IEquatable<MyQuaternion>, IFormattable
    {
        ...
        public Vec3 eulerAngles
        {
            get
            {
                ...
                if (xValue > 0.4999f * sqrMagnitude)
                {
                    ...
                    result.x = MathF.PI / 2;
                    result.z = 0;
                    return result * Converter.Rad2Deg;
                }
        ...
        public static Vec3 operator *(MyQuaternion rotation, Vec3 point)
        {
            ...
            Vec4 pointV4 = new Vec4(point.x, point.y, point.z, 1);

            Vec4 result = myRotationMatrix * pointV4;
        ...
        public static float Angle(MyQuaternion a, MyQuaternion b)
        {
            ...
            return a == b ? 0.0f : MathF.Acos(MathF.Min(dotAbs, 1.0f)) * 2 * Converter.Rad2Deg;
        }
        ...
        public static MyQuaternion AngleAxis(float angle, Vec3 axis)
        {
            ...
            axis *= MathF.Sin(angle * Converter.Deg2Rad * 0.5f);
            return new MyQuaternion(axis.x, axis.y, axis.z, MathF.Cos(angle * Converter.Deg2Rad * 0.5f));
        }
        ...
        public static MyQuaternion Euler(Vec3 euler)
        {
            ...
            float halfAngleToRadians = Converter.Deg2Rad * 0.5f;
        ...
        {
            Normalize();
            angle = 2.0f * MathF.Acos(w) * Converter.Rad2Deg;
